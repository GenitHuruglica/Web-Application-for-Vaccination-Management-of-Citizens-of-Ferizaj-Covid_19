			...
			<div id="main">
				...
				<!-- Section -->
					<section class="wrapper style1">
						<div class="inner">
							<div class="box">
							<h3>SHTO TË DHËNAT E QYTETARIT PER APLIKIM</h3>

										<form enctype="multipart/form-data" method="post" action="shto_a.php" >
											...
											<div class="col uniform">
												<div class="6u 12u$(xsmall)">
													...
													<div class="6u 12u$(xsmall)">
														<select name="ID_Faza" id="ID_Faza">
															<option selected="selected">Zgjedh Fzën e Vaksinës</option>
															<?php
												...
												<div class="12u$">
													<ul class="actions">
														<li><input type="submit" name="shto_a"  value="Shto" /></li>
													</ul>
												</div>
											</div>
						                    </form>     
