					...
					<section class="wrapper style1">
				                    	...
				                    	<form method="post" action="#">
											<div class="col align-center">
												...
												<h4>KËRKO TË DHËNAT E APLIKIMIT TE QYTETARIT PËR MODIFIKIM</h4>
												
												<div class="12u$">
													<ul class="actions">
														<li><input type="text" name="modifiko_a"  value="" placeholder="Emri" /></li>
											...
											<table>
												<thead>
													<tr>
														...
														<th>Data_Vaksinimit</th>														<th>Modifiko</th>
													</tr>
												</thead>
												
<?php
	if (!empty($_REQUEST['modifiko_a'])) {

	$term = mysqli_real_escape_string($lidh,$_REQUEST['modifiko_a']);     
...
WHERE
  s.Emri LIKE '%".$term."%'"
	...
	while($rresht = mysqli_fetch_array($sql)) { 		
			...
			echo "<td><a href=\"modifiko_a.php?ID_Q=$rresht[ID_Q]\" class='button' class='button primary'>Modifiko</a> </td>";			
		}
