				  ...
				  <hr>
					...
					<form method="post" action="#">
											<div class="col align-center">
												<h4>KËRKO TË DHËNAT E VENDBANIMIT PËR FSHIRJE</h4>
...
while($rresht = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><a href=\"fshije_vb.php?ID_Vendbanimi=$rresht[ID_Vendbanimi]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini vendbanimin?')\" class='button' class='button primary'>Fshijë</a>
		</td></tr>";		
	}
