	...
	<!-- Main -->
			<div id="main">
				...
				<header class="align-center">
								<h2>QYTETARET QE JANE REGJISTRUAR PER VAKSINIM</h2>	
				</header>
				...
				<section class="wrapper style1">
				                    	...
				                    	<form method="post" action="#">
											<div class="col align-center">
												...
												<h4>KËRKO TË DHËNAT E QYTETARIT </h4>
												
												<div class="12u$">
													<ul class="actions">
														<li><input type="text" name="Emri"  value="" placeholder="Emri Qytetarit / %" /></li>
...
<?php
	if (!empty($_REQUEST['Emri'])) {

	$term = mysqli_real_escape_string($lidh,$_REQUEST['Emri']);     
